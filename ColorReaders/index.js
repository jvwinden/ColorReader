 ...
 * The Intent Schema, Custom Slots, and Sample Utterances for this skill, as w ell as
...
exports.handler = (event, context, callback) => {
    try {
        console.log(`Het inkomende verzoek betreft: event.session.application.applicationId=${event.session.application.applicationId}`);


        if (event.session.application.applicationId !== 'amzn1.ask.skill.8b8c9e45-78bd-44b9-a1a3-57d444a2c17b') {
